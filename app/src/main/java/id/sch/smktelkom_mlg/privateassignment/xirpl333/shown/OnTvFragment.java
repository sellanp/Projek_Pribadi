...
import id.sch.smktelkom_mlg.privateassignment.xirpl333.shown.adapter.Ontv;
...
public class OnTvFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_on_tv, container, false);
        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.recycler_ontv);
        rv.setHasFixedSize(true);
        ontv = new Ontv(this, mList, getContext());
        rv.setAdapter(ontv);
    ...
    private void downloadDataResource() {
        String url = " https://api.themoviedb.org/3/tv/on_the_air?api_key=061e719562f20d0f5127bab6f3e5148a&language=en-US&page=1";
