...
import id.sch.smktelkom_mlg.privateassignment.xirpl333.shown.adapter.Airing;
...
public class AiringFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        airing = new Airing(this, mList, getContext());
    ...
    private void downloadDataResource() {
        String url = "https://api.themoviedb.org/3/tv/airing_today?api_key=061e719562f20d0f5127bab6f3e5148a&language=en-US&page=1";
